    ...
    return (
        <main>
            ...
            <Container className="p-5">
                ...
                <Row>
                    <Col md={4}>
                        <ul className="d-flex flex-column align-items-center justify-content-between text-center fs-5 border border-2 border-danger contact-box rounded">
                            <li>
                                <svg
                            ...
                            <li>
                                <p>
                                    1317 W Airline Hwy, Suite L <br /> Laplace,
                                    La 70068
                                </p>
                            </li>
                            <li>
